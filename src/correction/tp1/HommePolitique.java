...
public class HommePolitique implements Comparable<HommePolitique>, Cloneable {
	...
	public void setNom(String nom) {
		if (nom == null) {
			throw new IllegalArgumentException("la propri�t� nom ne peut pas �tre null");
		}
		this.nom = nom;
	}
	...
	public int compareTo(HommePolitique o) {
		int comp = 0;
		if ((o != null)) {
			// algo riqu� : reprendre celui de equals serait prudent
	...
	public String toString() {
		...
		return "[civilit� = " + civilite + ", nom = " + nom + ", parti = " + parti + "]";
	}
