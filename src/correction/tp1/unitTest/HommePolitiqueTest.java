...
public class HommePolitiqueTest {
	...
	public void HommePolitique() {
		assertNotNull("L'instance est cr��e", h1);
		assertNotNull("L'instance est cr��e", h3);
	}
	...
	public void testclone() {		
		...
		assertTrue("Est ce que h2 equals h1 apr�s clone", h2.equals(h1));
		assertNotSame("Est ce que h2 == h1", h2, h1);
	}
	@Test
	public void ToString() {		
		System.out.println("Test toString() " + h1);
		assertEquals("Test toString() ", h1.toString(),"[civilit� = FEMME, nom = nom1, parti = parti1]");
	}
	@Test
